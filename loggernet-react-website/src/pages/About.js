    ...
    return (
        <div className="about-container">
            ...
            <section className="who-we-are-section">
                <h2>Who We Are</h2>
                <p>
                    SAEON (South African Environmental Observation Network) is dedicated to environmental research and monitoring, working with diverse stakeholders to ensure data accessibility for researchers and decision-makers.
                </p>
            </section>
            ...
            <section className="contact-section">
                <h2>Get in Touch</h2>
                <p>
                    <strong>Location:</strong> 8th Floor, The Towers South, Hertzog Boulevard, Foreshore, Cape Town, 8001<br />
                    ...
                    <strong>Product Queries:</strong> <a href="mailto:datascience@saeon.ac.za">datascience@saeon.ac.za</a>
                </p>
            </section>
