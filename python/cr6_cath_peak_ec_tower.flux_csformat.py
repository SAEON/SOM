...
# Set parameters
url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR6_Cath Peak_EC Tower.Flux_CSFormat&format=json&mode=most-recent&p1=2800'
dbname = 'loggernet'
user = 'saeon'
password = 'jordan'
host = 'localhost'
