...
def insert_data_from_dataframe(dbname, user, password, host, port, table_name, dataframe):
    ...
    try:
        ...
        cursor = conn.cursor()
        column_mapping = {'TIMESTAMP': 'time', 'BattV_Min': 'battv_min', 'BP_kPa': 'bp_kpa', 'WS_ms_S_WVT': 'ws_ms_s_wvt', 'WindDir_D1_WVT': 'winddir_d1_wvt', 'WindDir_SD1_WVT': 'winddir_sd1_wvt', 'AirTC_Avg': 'airtc_avg', 'RH': 'rh', 'SlrW_Avg': 'slrw_avg', 'T107_C_Avg': 't107_c_avg', 'T107_C_Min': 't107_c_min', 'Rain_mm_Tot': 'rain_mm_tot', 'CUV5_Avg': 'cuv5_avg'}
...
def download_saeon_data():
    url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR1000_Cath%20Peak_Mikes%20Pass%20AWS.Hourly&format=json&mode=most-recent&p1=240'
