...
def download_saeon_data():
    url = 'https://lognet.saeon.ac.za/Besemfontein/?command=DataQuery&uri=Server:CR1000_Besemfontein.Table1_5min&format=json&mode=most-recent&p1=2800'
