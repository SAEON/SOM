...
# Set parameters
url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR6_Cath Peak_EC Tower.Config_Setting_Notes&format=json&mode=most-recent&p1=2800'
dbname = 'loggernet'
user = 'saeon'
password = 'jordan'
host = 'localhost'
...
table_name = 'config_setting_notes'
