...
def insert_data_from_dataframe(dbname, user, password, host, port, table_name, dataframe):
    ...
    try:
        ...
        cursor = conn.cursor()
        column_mapping = {'time': 'time', 'BattV_Min': 'battv_min', 'WS_ms_S_WVT': 'ws_ms_s_wvt', 'WindDir_D1_WVT': 'winddir_d1_wvt', 'WindDir_SD1_WVT': 'winddir_sd1_wvt', 'WS_ms_Max': 'ws_ms_max', 'AirTC_Max': 'airtc_max', 'AirTC_Min': 'airtc_min', 'RH_Max': 'rh_max', 'RH_Min': 'rh_min', 'Fog_Tot': 'fog_tot', 'VW_Max': 'vw_max', 'VW_Min': 'vw_min', 'VW_2_Max': 'vw_2_max', 'VW_2_Min': 'vw_2_min', 'VW_3_Max': 'vw_3_max', 'VW_3_Min': 'vw_3_min', 'VW_4_Max': 'vw_4_max', 'VW_4_Min': 'vw_4_min', 'Rain_Tot': 'rain_tot', 'VW_5_Max': 'vw_5_max', 'VW_5_Min': 'vw_5_min', 'VW_6_Max': 'vw_6_max', 'VW_6_Min': 'vw_6_min'}
...
def download_saeon_data():
    url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR1000_Constantiaberg.Table2&format=json&mode=most-recent&p1=10'
