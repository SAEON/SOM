...
# Set parameters
url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR3000_Jonkershoek EC.Flux_Notes&format=json&mode=most-recent&p1=2800'
dbname = 'loggernet'
user = 'saeon'
password = 'jordan'
host = 'localhost'
port = '5432'
schema_name = 'cr3000_Jonkershoek_ec'
table_name = 'flux_notes'
