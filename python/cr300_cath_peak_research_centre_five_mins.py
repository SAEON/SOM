...
# Set parameters
url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR300_Cath Peak_Research Centre.Five_mins&format=json&mode=most-recent&p1=2800'
dbname = 'loggernet'
user = 'saeon'
password = 'jordan'
host = 'localhost'
