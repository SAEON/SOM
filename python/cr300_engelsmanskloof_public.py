...
# Set parameters
url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR300 Engelsmanskloof.Public&format=json&mode=most-recent&p1=2800'
dbname = 'loggernet'
user = 'saeon'
password = 'jordan'
host = 'localhost'
port = '5432'
schema_name = 'cr300_engelsmanskloof'
table_name = 'public'
