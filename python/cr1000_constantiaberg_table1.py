...
def insert_data_from_dataframe(dbname, user, password, host, port, table_name, dataframe):
    ...
    try:
        ...
        cursor = conn.cursor()
        column_mapping = {'TIMESTAMP': 'time', 'WS_ms_S_WVT': 'ws_ms_s_wvt', 'WindDir_D1_WVT': 'winddir_d1_wvt', 'WindDir_SD1_WVT': 'winddir_sd1_wvt', 'AirTC_Avg': 'airtc_avg', 'RH': 'rh', 'Fog_Tot': 'fog_tot', 'VW_Avg': 'vw_avg', 'VW_2_Avg': 'vw_2_avg', 'VW_3_Avg': 'vw_3_avg', 'VW_4_Avg': 'vw_4_avg', 'Rain_Tot': 'rain_tot', 'VW_5_Avg': 'vw_5_avg', 'VW_6_Avg': 'vw_6_avg'}
...
def download_saeon_data():
    url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR1000_Constantiaberg.Table1&format=json&mode=most-recent&p1=240'
