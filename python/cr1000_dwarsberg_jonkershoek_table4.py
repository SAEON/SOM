...
def insert_data_from_dataframe(dbname, user, password, host, port, table_name, dataframe):
    ...
    try:
        ...
        cursor = conn.cursor()
        column_mapping ={'time': 'time', 'LWmV_Max': 'lwmv_max', 'LWmV_Min': 'lwmv_min', 'LWMDry_Tot': 'lwmdry_tot', 'LWMCon_Tot': 'lwmcon_tot', 'LWMWet_Tot': 'lwmwet_tot', 'LWmV_2_Max': 'lwmv_2_max', 'LWmV_2_Min': 'lwmv_2_min', 'LWMDry_2_Tot': 'lwmdry_2_tot', 'LWMCon_2_Tot': 'lwmcon_2_tot', 'LWMWet_2_Tot': 'lwmwet_2_tot'}
...
def download_saeon_data():
    url = 'https://lognet.saeon.ac.za/?command=dataquery&uri=Server:CR1000_Dwarsberg_Jonkershoek.Table4&format=json&mode=most-recent&p1=10'
