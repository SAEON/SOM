            ...
            <div className="nav-header">
                ...
                <div className="nav-title-container">
                    <div className="title-and-status">
                        <h1 className="nav-title">SAEON observations monitor</h1>
                    ...
                    <>
                        ...
                        {(user.role === 'Admin' || user.role === 'SU') && (
                            <>
                                ...
                                <Link to="/metadata-portal" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>
                                    Metadata Portal
                                </Link>
                        <Link to="/Analytics" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>
                        ...
                        <Link to="/issues" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>
                            Issues
                        </Link>
